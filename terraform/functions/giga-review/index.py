...
if __name__ == "__main__":
    ...
    while True:
        ...
        for update in resp_json['result']:
            print("update", update)
            if 'message' in update and 'reply_to_message' in update['message'] and 'is_topic_message' not in update['message']['reply_to_message'] and update['message']['reply_to_message']['from']['username'] != 'omni_fusion_ops_bot':
                print("ignore reply")
